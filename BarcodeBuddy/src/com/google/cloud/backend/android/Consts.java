...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "samlbest-cs496final";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "304062111328";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "304062111328-34i9vcbkb4e3crjkhc6cdm691nkhkga6.apps.googleusercontent.com";
